<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UnAuthorize.aspx.cs" Inherits="UnAuthorize" %>
                    ...
                    <asp:loginview id="loginview2" runat="server">
                        <RoleGroups>
                            <asp:RoleGroup Roles="Admin,Verify,License">
                                <ContentTemplate>
                                       <li><a href="../Business/index.aspx">ثبت اصناف</a></li> <li><a href="../Business/CartList.aspx">ثبت دست فروش</a></li>
                                </ContentTemplate>
                            </asp:RoleGroup>
                        </RoleGroups>
                        </asp:loginview>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <h3 style="text-align:center; font-family:'B Titre'"> شما به این صفحه دست رسی ندارید</h3>
    <br />
    <div class="row">
        <div class="col-md-4">
