<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BusinessGroup.aspx.cs" Inherits="MasterData_BusinessGroup" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
   ...
   <div class="panel-heading">تنظیم گروپ</div>
  <div class="panel-body">
    
                    <table class="table table-responsive">
                                <tr>
                                    <td>گروپ (انگلیسی):</td>
                                    <td><input runat="server" placeholder="گروپ در انگلیسی" id="txtName" class="form-control" required="required" /> 
                               </td>
                                </tr>
                                <tr>
                                    <td> گروپ (دری):</td>
                                    <td>  <input id="txtName_Local" runat="server" placeholder="گروپ در دری"  class="form-control" required="required" /> </td>
                                </tr>
                             <tr>
    ...
    <div class="panel panel-warning">
   <div class="panel-heading">لست گروپ ها</div>
  <div class="panel-body">
     <asp:GridView runat="server" ID="gvGroup" AutoGenerateColumns="False" Width="99%" CssClass="table table-bordered table-hover"  DataSourceID="dsGroup" EmptyDataText="هیچ گروپ موجود نیست" OnRowCommand="gvGroup_RowCommand">
           
       <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0" />
            <Columns>
                <asp:BoundField DataField="ID" HeaderText="شماره" />
                <asp:BoundField DataField="Name" HeaderText="گروپ (انگلیسی)" />
	            <asp:BoundField DataField="Name_local" HeaderText=" گروپ (دری)"  />
