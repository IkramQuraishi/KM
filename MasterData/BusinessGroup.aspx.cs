...
public partial class MasterData_BusinessGroup : System.Web.UI.Page
{
    ...
    void Save()
    {
        ...
        string INSERT = "INSERT INTO zbusinessGroup (Name, name_local) VALUES (@Name, @name_local)";
    ...
    void Edit()
    {
        ...
        string Edit = "update zbusinessGroup set Name=@Name, name_local=@name_local where ID=@ID";
    ...
    {
        DataTable dt = obj.Selectdt("select ID,Name,Name_Local from zbusinessGroup where ID=" + ID);
        if (dt.Rows.Count > 0)
        {
    ...
    protected void gvGroup_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "Del")
        {
            ...
            obj.execNonQuery("Delete from zbusinessGroup where ID=" + e.CommandArgument.ToString());
            gvGroup.DataBind();
        }
    }
}