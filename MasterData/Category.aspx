...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
   ...
   <div class="panel-heading">تنظیم کتگوری</div>
  <div class="panel-body">
    
                    <table class="table table-responsive">
                                <tr>
                                    <td>کتگوری (انگلیسی):</td>
                                    <td><input runat="server" placeholder="کتگوری در انگلیسی" id="txtName" class="form-control" required="required" /> 
                               </td>
                                </tr>
                                <tr>
                                    <td> کتگوری (دری):</td>
                                    <td>  <input id="txtName_Local" runat="server" placeholder="کتگوری در دری"  class="form-control" required="required" /> </td>
                                </tr>
                             <tr>
    ...
    <div class="panel panel-warning">
   <div class="panel-heading">لست کتگوری</div>
  <div class="panel-body">
     <asp:GridView runat="server" ID="gvGroup" AutoGenerateColumns="False" Width="99%" CssClass="table table-bordered table-hover"  DataSourceID="dsGroup" EmptyDataText="هیچ کتگوری موجود نیست" OnRowCommand="gvGroup_RowCommand">
           
       <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
            <Columns>
                <asp:BoundField DataField="ID" HeaderText="شماره" />
                <asp:BoundField DataField="Name" HeaderText="کتگوری (انگلیسی)" />
	            <asp:BoundField DataField="Name_local" HeaderText=" کتگوری (دری)"  />
