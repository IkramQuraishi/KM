<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="Business_index" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
            ...
            $("#ctl00_Content_txtFName").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        type: "POST",
                        contentType: "application/json;charset=utf-8",
                        url: "index.aspx/GetOwnerFatherName",
    ...
    <div class="panel panel-warning">
       <div class="panel-heading"> اصناف <span style="float:left;"><asp:LinkButton ID="btnNew" runat="server" CssClass="btn btn-warning" OnClick="btnNew_Click"><span aria-hidden="true" class="glyphicon glyphicon-plus"><span style="font-family:Droid Arabic Naskh,sans-serif">   جدید  </span></span></asp:LinkButton></span></div>
        <div class="panel-body">
            <div class="table-responsive">
               <asp:GridView runat="server" ID="gvGroup" AutoGenerateColumns="False" Width="99%" CssClass="table table-bordered table-hover"  DataSourceID="dsPaymentCategory" 
                   EmptyDataText="هیچ تشبث موجود نیست" OnRowCommand="gvGroup_RowCommand" OnRowDataBound="gvGroup_RowDataBound" AllowPaging="true" PageSize="10" OnPageIndexChanged="gvGroup_PageIndexChanged">
