<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BusinessToVerify.aspx.cs" Inherits="BusinessToVerify" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center;">تائید تشبث</h3>
    ...
    <div class="panel panel-warning">
       <div class="panel-heading"> اصناف برای تائیدی </div>
        <div class="panel-body">
            <div class="table-responsive">
               <asp:GridView runat="server" ID="gvGroup" AutoGenerateColumns="False" Width="99%" CssClass="table table-bordered table-hover"  DataSourceID="dsPaymentCategory" EmptyDataText="هیچ تشبث موجود نیست" OnRowCommand="gvGroup_RowCommand" OnRowDataBound="gvGroup_RowDataBound" AllowPaging="true" PageSize="100">
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
                <Columns>
                    <asp:BoundField DataField="ID" HeaderText="شماره" />
                     ...
                     <asp:TemplateField>
		                <HeaderTemplate>نوع فعالیت</HeaderTemplate>
		                <ItemTemplate>
                            <%#Eval("BusinessName") %>
		                </ItemTemplate>
	                ...
	                <asp:TemplateField>
		                ...
		                <ItemTemplate>
                           <%-- <asp:LinkButton ID="lnkEdit" runat="server" CssClass="glyphicon glyphicon-edit" CommandArgument='<%#Eval("ID") %>' CommandName="Ed" Visible="false" ToolTip="تغیر"></asp:LinkButton>
		                   ...
		                   --%> <asp:LinkButton ID="lnkView" runat="server" CssClass="glyphicon glyphicon-ok" ToolTip="تماشا" CommandArgument='<%#Eval("ID") %>' CommandName="View"  CausesValidation="false" ></asp:LinkButton>
                        </ItemTemplate>
