<%@ Page Title="سیستم دیتابیس برای ثبت دست فروشان" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CreateCart.aspx.cs" Inherits="CreateCart" %>
...
<script type="text/javascript">
   ...
   <h3 class="text-center"> ثبت دست فروش </h3>
     <div class="alert alert-success" role="alert" runat="server" visible="false" id="dvMessage"> دست فروش ثبت شد</div>
       ...
       <div class="panel-heading"> مشخصات عمومی</div>
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-2">نوع فعالیت : <span style="color:#f00; font-size:1em;">*</span> </div>
                <div class="col-md-4"><input id="txtEName" runat="server" class="form-control input-sm" placeholder="نوع فعالیت " autocomplete="off"/>
            ...
            <div class="row">
                <div class="col-md-2">تاریخ راجستر: <span style="color:#f00; font-size:1em;">*</span> </div>
                <div class="col-md-4"><input type="text" id="txtApplicationDate" placeholder="تاریخ راجستر" runat="server" class="form-control" autocomplete="off" />
             ...
             <div class="row">
                <div class="col-md-2">اسم نماینده: <span style="color:#f00; font-size:1em;">*</span> </div>
                <div class="col-md-4"><input type="text" id="txtRep" placeholder="اسم نماینده" runat="server" class="form-control" autocomplete="off" />
                     <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txtRep" ValidateEmptyText="true" ClientValidationFunction="Validate"></asp:CustomValidator>
                </div>
                </div>
           </div>
        </div>
     ...
     <div class="panel panel-warning" >
       <div class="panel-heading"> ادرس </div>
        <div class="panel-body">
             ...
             <div class="row">
                <div class="col-md-2">طول البلد:  </div>
                <div class="col-md-4"><input id="txtLatitude" runat="server" class="form-control input-sm" placeholder="طول البلد" autocomplete="off" />
                    
                </div>
                 <div class="col-md-2">عرض البلد: </div>
                <div class="col-md-4"><input id="txtLongnitude" runat="server" class="form-control input-sm" placeholder="عرض البلد" autocomplete="off"/>
    ...
    <div class="row">
                <div class="col-md-6"><asp:LinkButton ID="btnSave" runat="server" CssClass="btn btn-warning" data-toggle="modal" data-target="#myModal"><span aria-hidden="true" class="glyphicon glyphicon-floppy-disk"><span style="font-family:Droid Arabic Naskh,sans-serif">   ثبت نماید  </span></span></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnCancel" runat="server" CausesValidation="false" CssClass="btn btn-warning" OnClick="btnCancel_Click"><span aria-hidden="true" class="glyphicon glyphicon-remove"><span style="font-family:Droid Arabic Naskh,sans-serif">   برگشت به لست  </span></span></asp:LinkButton>
                    <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-warning" OnClick="LinkButton2_Click"><span aria-hidden="true" class="glyphicon glyphicon-print"><span style="font-family:Droid Arabic Naskh,sans-serif">   پرنت جواز  </span></span></asp:LinkButton>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      آیا شما میخواهید این دستفروش را ثبت نماید؟
      </div>
