<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VerifyBusiness.aspx.cs" Inherits="VerifyBusiness" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
   ...
   <h3 class="text-center">تفصیل تشبث</h3>
       ...
       <div class="panel-heading"> مشخصات عمومی تشبث</div>
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4"> <asp:Image ID="Image1" runat="server" Width="150px" Height="150px"/></div>
            </div>
           </div>
        </div>
    ...
    <div class="row">
                <div class="col-md-4"> 
                    <asp:LinkButton ID="btnVerify" runat="server" CssClass="btn btn-warning" data-toggle="modal" data-target="#myModal"><span aria-hidden="true" class="glyphicon glyphicon-ok"><span style="font-family:Droid Arabic Naskh,sans-serif">   تاید نماید  </span></span></asp:LinkButton>
                    <asp:LinkButton ID="btnCancel" runat="server" CssClass="btn btn-warning" PostBackUrl="~/Business/BusinessToVerify.aspx"><span aria-hidden="true" class="glyphicon glyphicon-backward"><span style="font-family:Droid Arabic Naskh,sans-serif">   پس به لست تشبسات  </span></span></asp:LinkButton>
                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      آیا شما میخواهید این تثبث را تاید نماید؟
      </div>
      <div class="modal-footer">
           <asp:Button ID="Button1" CssClass="btn btn-warning" runat="server" Text="بلی تاید نماید" OnClick="btnVerify_Click"> </asp:Button>
