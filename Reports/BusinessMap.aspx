<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BusinessMap.aspx.cs" Inherits="BusinessMap" %>
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-1">کود تشبث: </div>
                 ...
                 <div class="col-md-2"><asp:TextBox ID="txtYear" runat="server"  CssClass="form-control"></asp:TextBox></div>
