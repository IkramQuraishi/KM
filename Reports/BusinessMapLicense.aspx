<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BusinessMapLicense.aspx.cs" Inherits="BusinessMapLicense" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center"> نقشه اصناف به اساس اخذ جواز </h3>
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-1">کود تشبث: </div>
                 ...
                 <div class="col-md-2"><asp:TextBox ID="txtAddress" runat="server"  CssClass="form-control"></asp:TextBox></div>
    ...
    <script type="text/javascript">
        ...
        <ItemTemplate>
                 {
                    "paymentstatus": '<%# Eval("paymentstatus") %>',
                     "title": '<%# Eval("title") %>',
                     "lat": '<%# Eval("Latitude") %>',
                     "lng": '<%# Eval("Longitude") %>',
            ...
            for (i = 0; i < markers.length; i++) {
                ...
                (function (marker, data) {
                    google.maps.event.addListener(marker, "click", function (e) {
                        var contentString = '<div id="content" style="width:120px;"><span style="padding-righ:10px; font-bold:true;">اسم تشبث: </span>' +
