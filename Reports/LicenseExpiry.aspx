<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LicenseExpiry.aspx.cs" Inherits="LicenseFeeDueReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center"> راپور معیاد جواز </h3>
            ...
            <div class="row">
                ...
                <div class="col-md-2"><input id="txtCode" runat="server" class="form-control input-sm" placeholder="کود "/></div>
                 ...
                 <div class="col-md-2"><asp:DropDownList runat="server" ID="ddlDistrict" DataSourceID="dsDistrict" DataTextField="Name_Local" DataValueField="ID" CssClass="form-control"></asp:DropDownList>
                                ...
                                <div class="col-md-1">آدرس: </div>
                 <div class="col-md-2"><input id="txtaddress" runat="server" class="form-control input-sm" placeholder="آدرس" autocomplete="off" /> </div>
       ...
       <div class="panel-heading">  لست اصناف </div>
        <div class="panel-body">
            <div class="table-responsive">
               <asp:GridView runat="server" ID="gvGroup" AutoGenerateColumns="False" Width="99%" CssClass="table table-bordered table-hover"  DataSourceID="dsReport" EmptyDataText="هیچ  موجود نیست" ShowFooter="true" OnRowDataBound="gvGroup_RowDataBound" AllowPaging="true" PageSize="100"  >
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Address" HeaderText="آدرس" />
                     <asp:BoundField DataField="Phone" HeaderText="شماره تماس" />
                      <asp:BoundField DataField="IssueDate" HeaderText="تاریخ صدور جواز" />
                    <asp:BoundField DataField="License" HeaderText="تاریخ اعتبار جواز" />
