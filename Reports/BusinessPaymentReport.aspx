<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BusinessPaymentReport.aspx.cs" Inherits="BusinessPaymentReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center"> راپور پرداخت های اصناف </h3>
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
                ...
                <Columns>
                   ...
                   <%--  <asp:BoundField DataField="FatherName" HeaderText="اسم پدر" />--%>
                    ...
                    <asp:BoundField DataField="License" HeaderText="فیس خدمات شهری" />
                    <asp:BoundField DataField="ClassFee" HeaderText="فیس لوحه" />
