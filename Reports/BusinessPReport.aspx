<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BusinessPReport.aspx.cs" Inherits="BusinessPaymentReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center"> راپور فیس جواز سالانه صنفی </h3>
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
                ...
                <Columns>
                   ...
                   <%--  <asp:BoundField DataField="FatherName" HeaderText="اسم پدر" />--%>
                    ...
                    <asp:BoundField DataField="Payment" HeaderText="فیس خدمات شهری" />
