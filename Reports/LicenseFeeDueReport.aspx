<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LicenseFeeDueReport.aspx.cs" Inherits="LicenseFeeDueReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <h3 style="text-align:center ; font-family:'B Titre'"> راپور عدم پرداخت  فیس اجازه فعالیت صنفی </h3>
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-1"><input type="text" id="txtYear" placeholder="سال" runat="server" class="form-control" /> 
                    <asp:CustomValidator ID="CustomValidator7" runat="server" ControlToValidate="txtYear" ValidateEmptyText="true" ClientValidationFunction="Validate"></asp:CustomValidator></div>
       ...
       <div class="panel-heading">  لست اصناف </div>
        <div class="panel-body">
            <div class="table-responsive">
               <asp:GridView runat="server" ID="gvGroup" AutoGenerateColumns="False" Width="99%" CssClass="table table-bordered table-hover"  DataSourceID="dsReport" EmptyDataText="هیچ  موجود نیست" ShowFooter="true" OnRowDataBound="gvGroup_RowDataBound" OnRowCommand="gvGroup_RowCommand" AllowPaging="true" PageSize="100" OnPageIndexChanged="gvGroup_PageIndexChanged" >
