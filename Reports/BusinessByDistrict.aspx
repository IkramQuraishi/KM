<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BusinessByDistrict.aspx.cs" Inherits="BusinessByDistrict" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <div class="panel panel-warning">
       <div class="panel-heading">  تعداد اصناف به اساس ناحیه</div>
        <div class="panel-body">
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
             ...
             <asp:SqlDataSource runat="server" ID="dsPaymentCategory" ConnectionString='<%$ ConnectionStrings:Conn %>'        
                   SelectCommand="select c.Name_Local as Class, count(Distinct b.ID) as Businesses from Business b inner join zDistrict c on c.ID=b.DistrictID where  b.DistrictID=(Case when @DistrictID<>-1 then @districtID else b.DistrictID end) group by c.Name_Local">
                 <SelectParameters>
