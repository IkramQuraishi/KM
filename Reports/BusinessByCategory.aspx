<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BusinessByCategory.aspx.cs" Inherits="BusinessByCategory" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center"> راپور اصناف به اساس کتگوری</h3>
       ...
       <div class="panel-heading">جستجو </div>
        <div class="panel-body">
            <div class="row">
                         ...
                         <div class="col-md-1">کتگوری: </div>
                 <div class="col-md-2"><asp:DropDownList runat="server" ID="ddlGroup" DataSourceID="dsGroup" DataTextField="Name_Local" DataValueField="ID" CssClass="form-control" ></asp:DropDownList>
                                      <asp:SqlDataSource runat="server" ID="dsGroup" ConnectionString='<%$ ConnectionStrings:Conn %>'        
                                       SelectCommand="Select ID,Name_Local from zBusinessCategory union select -1,N'--انتخاب--' order by ID">
    ...
    <div class="panel panel-warning">
       <div class="panel-heading">  تعداد اصناف به اساس کتگوری</div>
        <div class="panel-body">
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
                ...
                <Columns>
                     ...
                     <asp:TemplateField>
		                <HeaderTemplate>تعداد اصناف</HeaderTemplate>
		                <ItemTemplate>
                            <%#Eval("Businesses") %>
		                </ItemTemplate>
             ...
             <asp:SqlDataSource runat="server" ID="dsPaymentCategory" ConnectionString='<%$ ConnectionStrings:Conn %>'        
                   SelectCommand="select c.Name_Local as Class, count(Distinct b.ID) as Businesses from Business b inner join zBusinessCategory c on c.ID=b.BusinessCategoryID where c.ID=(Case when @ClassID<>-1 then @ClassID else c.ID end) and b.DistrictID=(Case when @DistrictID<>-1 then @districtID else b.DistrictID end) group by c.Name_Local">
                 <SelectParameters>
                                                 <asp:ControlParameter ControlID="ddlGroup" PropertyName="SelectedValue" Name="ClassID" ConvertEmptyStringToNull="true" />
