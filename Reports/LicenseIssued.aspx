<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LicenseIssued.aspx.cs" Inherits="LicenseIssued" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center"> راپور توزیع جوازها </h3>
        ...
        <div class="panel-body">
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Licenses" HeaderText="تعداد جوازهای توزیع شده" />
