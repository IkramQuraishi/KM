<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RevenueByDistrict.aspx.cs" Inherits="RevenueByDistrict" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center"> راپورجمع آوری عواید </h3>
        ...
        <div class="panel-body">
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="LicensePayment" HeaderText="فیس خدمات شهری" />
                    <asp:BoundField DataField="SignboardPayment" HeaderText="فیس لوحه" />
