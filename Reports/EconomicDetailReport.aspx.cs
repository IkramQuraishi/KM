...
public partial class EconomicDetailReport : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        dsReport.SelectCommand = @"select b.ID, b.code,b.BusinessName,b.OwnerName,b.FatherName,b.Tazkira,b.Street,b.Address,b.ShopNumber,b.Phone,b.Email,b.EmployeeMale,b.EmployeeFemale,
isnull(b.EmployeeMale,0)+isnull(b.EmployeeFemale,0) as TotalEmployees,b.AnnualSales,
                                               ...
                                               dbo.ToPersianDate(b.ApplicationDate) as ApplicationDate,
                                                ...
                                                left outer join zApprovalStatus a on a.id=b.ApprovalStatusID where " + filter;
        dsReport.DataBind();
        gvGroup.DataBind();
    }
