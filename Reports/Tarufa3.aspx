<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tarufa3.aspx.cs" Inherits="Tarufa3" %>
    ...
    <div>
                <asp:ListView runat="server" ID="lstTarufa" 
                      ...
                      <ItemTemplate>
                         ...
                         <tr>
                              <td colspan="11" style="border-top:0px !important;text-align:right">لطفا مبلغ <strong> <%#Eval("LicenseFee") %> </strong> افغاني را از بابت فيس اجازه فعالیت صنفی کتگوري</strong>  <strong><%#Eval("category") %> </strong> برای سال  <strong> <%#Eval("YearID") %> در حساب ناحیه (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;) شاروالي کابل تاديه نمايید<br /><br /><br />
        ...
        <asp:ListView runat="server" ID="ListView1" 
                      ...
                      <ItemTemplate>
                         ...
                         <tr>
                          ...
                          <tr>
                              <td colspan="11" style="border-top:0px !important;text-align:right">لطفا مبلغ <strong> <%#Eval("LicenseFee") %> </strong> افغاني را از بابت  فيس اجازه فعالیت صنفی کتگوري</strong>  <strong><%#Eval("category") %> </strong> برای سال  <strong> <%#Eval("YearID")  %> در حساب ناحیه (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;) شاروالي کابل تاديه نمایيد<br /><br /><br />
                                  <span style="text-align:center;padding-right:50%;"><strong>مهر بانک: </strong></span>
                              </td>
                          </tr>
