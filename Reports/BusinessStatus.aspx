<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BusinessStatus.aspx.cs" Inherits="BusinessStatus" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center"> راپورجواز فعالیت اصناف </h3>
        ...
        <div class="panel-body">
            <div class="row">
              ...
              <div class="row">
                 ...
                 <div class="col-md-8"><input id="txtaddress" runat="server" class="form-control input-sm" placeholder="آدرس" autocomplete="off" /> </div>
       ...
       <div class="panel-heading">  لست اصناف </div>
        <div class="panel-body">
            <div class="table-responsive">
               <asp:GridView runat="server" ID="gvGroup" AutoGenerateColumns="False" Width="99%" CssClass="table table-bordered table-hover"  DataSourceID="dsReport" EmptyDataText="هیچ  موجود نیست" ShowFooter="true" OnRowDataBound="gvGroup_RowDataBound" OnRowCommand="gvGroup_RowCommand" AllowPaging="true" PageSize="100" >
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="BusinessLicense" HeaderText="جواز فعالیت اخذ کرده" />
