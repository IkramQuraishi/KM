<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TargetByDistrict.aspx.cs" Inherits="TargetByDistrict" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <h3 style="text-align:center"> راپورتحصیل عواید </h3>
        ...
        <div class="panel-body">
            <div class="row">
                 ...
                 <div class="col-md-2"><asp:DropDownList runat="server" ID="ddlDistrict" DataSourceID="dsDistrict" DataTextField="Name_Local" DataValueField="ID" CssClass="form-control"></asp:DropDownList>
                     ...
                     <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="ddlDistrict" ValidateEmptyText="true" ClientValidationFunction="ValidateDDL"></asp:CustomValidator>
                 </div>
               
               
                    <div class="col-md-1">سال : </div>
                <div class="col-md-2"><input type="text" id="txtYear" placeholder="سال" runat="server" class="form-control" />
                     <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txtYear" ValidateEmptyText="true" ClientValidationFunction="Validate"></asp:CustomValidator>
                   </div>
       ...
       <div class="panel-heading">  لست ناحیه </div>
        <div class="panel-body">
            <div class="table-responsive">
               <asp:GridView runat="server" ID="gvGroup" AutoGenerateColumns="False" Width="99%" CssClass="table table-bordered table-hover"  DataSourceID="dsReport" EmptyDataText="هیچ  موجود نیست" ShowFooter="true" OnRowDataBound="gvGroup_RowDataBound" OnRowCommand="gvGroup_RowCommand" >
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Target" HeaderText="هدف" />
                    <asp:BoundField DataField="Revenue" HeaderText="عواید" />
                     <asp:BoundField DataField="Achieved" HeaderText="فیصدی به دست آمده" DataFormatString="{0:N}" />
             ...
             <asp:SqlDataSource runat="server" ID="dsReport" ConnectionString='<%$ ConnectionStrings:Conn %>'        
                   SelectCommand="">
                 <SelectParameters><asp:Parameter Name="Year" /><asp:Parameter Name="District" /></SelectParameters>
