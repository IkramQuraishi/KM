<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TarufaDistList.aspx.cs" Inherits="TarufaDistList" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center"> لست اصناف که تعرفه برایشان توزیع گردیده </h3>
       ...
       <div class="panel-heading">جستجو </div>
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-1"><input type="text" id="txtYear" placeholder="سال " runat="server" class="form-control" /></div>
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
                ...
                <Columns>
                   ...
                   <%-- <asp:BoundField DataField="Class" HeaderText="صنف" />
                    ...
                    <asp:BoundField DataField="AmountDue" HeaderText="قیمت تعرفه" />
                    <asp:BoundField DataField="tarufaDate" HeaderText="تاریخ توزیع" />
                    <asp:BoundField DataField="YearID" HeaderText="سال" />
                </Columns>
