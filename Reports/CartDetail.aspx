<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CartDetail.aspx.cs" Inherits="CartDetail" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center"> راپورتفصیلی دست فروشان </h3>
        ...
        <div class="panel-body">
            <div class="row">
             ...
             <div class="row">
                  ...
                  <div class="col-md-1">نوع فعالیت : </div>
        ...
        <div class="panel-body">
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="نوع فعالیت" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnk"  runat="server" CommandName="show" CommandArgument='<%#Eval("ID") %>'><%#Eval("BusinessName") %></asp:LinkButton>
                        </ItemTemplate>

                    </asp:TemplateField>
                  <%--  <asp:BoundField DataField="BusinessName" HeaderText="نوع فعالیت" />--%>
