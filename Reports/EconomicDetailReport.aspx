<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EconomicDetailReport.aspx.cs" Inherits="EconomicDetailReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center"> راپورتفصیلی اقتصادی اصناف </h3>
       ...
       <div class="panel-heading">  لست اصناف </div>
        <div class="panel-body">
            <div class="table-responsive">
               <asp:GridView runat="server" ID="gvGroup" AutoGenerateColumns="False" Width="99%" CssClass="table table-bordered table-hover"  DataSourceID="dsReport" AllowPaging="true" PageSize="100" EmptyDataText="هیچ  موجود نیست" ShowFooter="true" OnRowDataBound="gvGroup_RowDataBound" OnRowCommand="gvGroup_RowCommand" >
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="EmployeeMale" HeaderText="کامندان مردانه" />
                    <asp:BoundField DataField="EmployeeFemale" HeaderText="کارمندان زنانه" />
                    <asp:BoundField DataField="TotalEmployees" HeaderText="مجموع کارمندان" />
                    <asp:BoundField DataField="AnnualSales" HeaderText="فروشات سالانه" />
                </Columns>
