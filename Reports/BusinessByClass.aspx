<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BusinessByClass.aspx.cs" Inherits="Reports_BusinessByClass" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    <h3 style="text-align:center"> راپور اصناف به اساس صنف</h3>
    ...
    <div class="panel panel-warning">
       <div class="panel-heading">  تعداد اصناف به اساس صنف</div>
        <div class="panel-body">
           ...
           <HeaderStyle Height="30px" HorizontalAlign="Center" BackColor="#eccdb0"  />
             ...
             <asp:SqlDataSource runat="server" ID="dsPaymentCategory" ConnectionString='<%$ ConnectionStrings:Conn %>'        
                   SelectCommand="select c.Name_Local as Class, count(Distinct b.ID) as Businesses from Business b inner join zBusinessClass c on c.ID=b.BusinessClassID where c.ID=(Case when @ClassID<>-1 then @ClassID else c.ID end) and b.DistrictID=(Case when @DistrictID<>-1 then @districtID else b.DistrictID end)
group by c.Name_Local">
                 <SelectParameters>
                                                 <asp:ControlParameter ControlID="ddlClass" PropertyName="SelectedValue" Name="ClassID" ConvertEmptyStringToNull="true" />
