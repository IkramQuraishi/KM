...
select business.ID,business.code,businessName,OwnerName, c.Name_Local as Class,ct.Name_Local as Category, d.Name_Local as District,isnull(p.LicenseFee,0) as License,isnull(p.ClassFee,0) as ClassFee
