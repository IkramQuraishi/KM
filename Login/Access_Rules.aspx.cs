...
{
    public const string VirtualImageRoot = "~/";
    ...
    public TreeNode AddNodeAndDescendents(DirectoryInfo folder, TreeNode parentNode)
    {
        /*
         * Dan Clem, 4/15/2007.
         * The PopulateTree and AddNodeAndDescendents are taken almost verbatim from Scott Mitchell's article
    ...
    public void ResetFolderImageUrls(TreeNode parentNode)
    {
        /*
         * Dan Clem, 3/21/2007.
    ...
    public void AddFirstGroupOfRules(AuthorizationSection section,
        ArrayList rulesArray, int selectedIndex, string upOrDown)
    {
        int adj;
